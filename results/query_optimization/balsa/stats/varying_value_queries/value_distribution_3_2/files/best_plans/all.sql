...
/*+ NestLoop(u p b v)
 ...
 IndexScan(v)
 Leading((((u p) b) v)) */
SELECT COUNT(*) FROM votes as v, posts as p, badges as b, users as u WHERE p.Id = v.PostId AND u.Id = p.OwnerUserId AND u.Id = b.UserId AND p.Score>-13 AND p.Score<164 AND p.CommentCount>26 AND p.CommentCount<38 AND u.DownVotes>68 AND u.DownVotes<1671 AND v.CreationDate>'2010-12-16 12:13:12'::timestamp AND v.CreationDate<'2012-11-09 02:40:13'::timestamp AND v.VoteTypeId>1 AND v.VoteTypeId<4 AND b.Date>'2012-05-28 02:39:11'::timestamp AND b.Date<'2012-10-16 03:22:28'::timestamp;
...
/*+ NestLoop(u p v b)
 ...
 IndexScan(b)
 Leading((((u p) v) b)) */
SELECT COUNT(*) FROM votes as v, posts as p, badges as b, users as u WHERE p.Id = v.PostId AND u.Id = p.OwnerUserId AND u.Id = b.UserId AND p.Score>-2 AND p.Score<92 AND p.CommentCount>1 AND p.CommentCount<17 AND u.DownVotes>731 AND u.DownVotes<859 AND v.CreationDate>'2011-08-27 04:25:28'::timestamp AND v.CreationDate<'2012-07-01 02:14:25'::timestamp AND v.VoteTypeId>6 AND v.VoteTypeId<12 AND b.Date>'2011-01-22 06:42:42'::timestamp AND b.Date<'2011-11-26 10:30:19'::timestamp;
