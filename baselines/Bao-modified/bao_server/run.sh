...
do
    CUDA_VISIBLE_DEVICES=2 python3 -u baoctl.py \
	    ...
	    --dataset ${dataset} \
            --repeat 0 \
	    --alpha 0.5 \
	    --train_query_file workloads/${dataset}/varying_label_queries/${i}_label_queries/${i}_label_queries_plans \
	    --train_label_file workloads/${dataset}/varying_label_queries/${i}_label_queries/${i}_label_queries_time.txt \
	    --save_folder workloads/${dataset}/varying_label_queries/${i}_label_queries \
	    --predict_query_file workloads/${dataset}/varying_label_queries/${j}_label_queries/${j}_label_queries_plans \
	    --predict_label_file workloads/${dataset}/varying_label_queries/${j}_label_queries/${j}_label_queries_time.txt
