...
#do
#CUDA_VISIBLE_DEVICES=3 python3 train.py --dataset ${dataset} --epochs 50 --cuda --train_query_file workloads/${dataset}/varying_column_queries/queries_${i}_columns/queries_${i}_columns.csv --predict_query_file workloads/${dataset}/varying_column_queries/queries_4_columns/queries_4_columns.csv
#CUDA_VISIBLE_DEVICES=3 python3 train.py --dataset ${dataset} --epochs 50 --cuda --train_query_file workloads/${dataset}/varying_column_queries/queries_${i}_columns/queries_${i}_columns.csv --predict_query_file workloads/${dataset}/varying_column_queries/queries_4_columns/queries_4_columns.csv --robust
#done

for i in 4
do
CUDA_VISIBLE_DEVICES=3 python3 train.py --dataset ${dataset} --epochs 50 --cuda --train_query_file $HOME/learnedcardinalities/workloads/${dataset}/varying_table_queries/queries_${i}_tables/queries_${i}_tables.csv --predict_query_file $HOME/learnedcardinalities/workloads/${dataset}/varying_table_queries/queries_4_tables/queries_4_tables.csv
#CUDA_VISIBLE_DEVICES=3 python3 train.py --dataset ${dataset} --epochs 50 --cuda --train_query_file workloads/${dataset}/varying_table_queries/queries_${i}_tables/queries_${i}_tables.csv --predict_query_file workloads/${dataset}/varying_table_queries/queries_3_tables/queries_3_tables.csv --robust
done
